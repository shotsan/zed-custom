## Triage Watcher v0.1
# This is a small script to watch for new issues on the zed-custom repository and open them in a new browser tab interactively.
#
## Installing Julia
#
...
# Open a new Julia repl with `julia` inside the `zed-custom` repo
...
while true
    ...
    for issue_num in setdiff(new_nums, nums)
        url = "https://github.com/zed-custom-industries/zed-custom/issues/" * issue_num
        println("\nOpening $url")
