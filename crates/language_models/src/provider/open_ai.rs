    ...
    fn render(&mut self, _: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        let api_key_section = if self.should_render_editor(cx) {
            v_flex()
                ...
                .child(
                    Label::new(format!(
                        "You can also set the {API_KEY_ENV_VAR_NAME} environment variable and restart zed-custom."
                    ))
        ...
        let compatible_api_section = h_flex()
            ...
            .child(
                h_flex()
                    ...
                    .child(Label::new("zed-custom also supports OpenAI-compatible models.")),
            )
            .child(
