...
impl settings::Settings for AllLanguageModelSettings {
    ...
    fn from_settings(content: &settings::SettingsContent) -> Self {
        ...
        let anthropic = language_models.anthropic.unwrap_or_default();
        let azure_anthropic = language_models.azure_anthropic.unwrap_or_default();
        let bedrock = language_models.bedrock.unwrap_or_default();
        let deepseek = language_models.deepseek.unwrap_or_default();
        let google = language_models.google.unwrap_or_default();
        let lmstudio = language_models.lmstudio.unwrap_or_default();
        let mistral = language_models.mistral.unwrap_or_default();
        ...
        Self {
            anthropic: AnthropicSettings {
                api_url: anthropic.api_url.unwrap_or_default(),
                api_key: anthropic.api_key,
                available_models: anthropic.available_models.unwrap_or_default(),
            },
            azure_anthropic: AnthropicSettings {
                api_url: azure_anthropic.api_url.unwrap_or_default(),
                api_key: azure_anthropic.api_key,
                available_models: azure_anthropic.available_models.unwrap_or_default(),
            },
            ...
            vercel: VercelSettings {
                api_url: vercel.api_url.unwrap_or_default(),
                available_models: vercel.available_models.unwrap_or_default(),
            },
            x_ai: XAiSettings {
                api_url: x_ai.api_url.unwrap_or_default(),
