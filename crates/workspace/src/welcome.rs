                                ...
                                v_flex()
                                    ...
                                    .child(
                                        v_flex()
                                            ...
                                            .child(Label::new("· Code intelligence: definitions, references & implementations via LSP").size(LabelSize::Small).color(Color::Muted))
                                            .child(Label::new("· DuckDuckGo static search, fetch URLs, headless browser navigation").size(LabelSize::Small).color(Color::Muted))
                                            .child(Label::new("· Symbol search across the codebase via LSP").size(LabelSize::Small).color(Color::Muted))
                                    )
                                    .child(
                                        v_flex()
                                            .w_full()
                                            ...
                                            .child(Label::new("· Write: full tool access, edits files, runs terminal commands").size(LabelSize::Small).color(Color::Muted))
                                            .child(Label::new("· Ask: read-only, explores codebase, no file mutations").size(LabelSize::Small).color(Color::Muted))
                                            .child(Label::new("· Minimal: no tools, pure conversation").size(LabelSize::Small).color(Color::Muted))
                                    )
                                    .child(
                                        v_flex()
                                            .w_full()
                                            ...
                                            .child(Label::new("· Long-term: persists across sessions — architecture, patterns, issues, procedures").size(LabelSize::Small).color(Color::Muted))
                                            .child(Label::new("· Short-term: session-only notes").size(LabelSize::Small).color(Color::Muted))
                                            .child(Label::new("· Ask the agent to remember or recall anything by name").size(LabelSize::Small).color(Color::Muted))
                                    )
                                    .child(
                                        v_flex()
                                            .w_full()
                                            ...
                                            .child(Label::new("· /deep-research <topic> — multi-tab headless Chrome with LLM synthesis").size(LabelSize::Small).color(Color::Muted))
                                            .child(Label::new("· /custom-search <query> — queries your configured search endpoint").size(LabelSize::Small).color(Color::Muted))
                                            .child(Label::new("· Expands topics, ranks sources, fills gaps between iterations").size(LabelSize::Small).color(Color::Muted))
                                    )
                            )
                            .when(!self.fallback_to_recent_projects, |this: gpui::Stateful<gpui::Div>| {
                                this.child(
