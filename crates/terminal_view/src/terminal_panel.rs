                            ...
                            .menu(move |window, cx| {
                                ...
                                let menu = ContextMenu::build(window, cx, |menu, _, _| {
                                    menu.context(focus_handle.clone())
                                        ...
                                        .action(
                                            "Spawn Task",
                                            zed_custom_actions::Spawn::modal().boxed_clone(),
                                        )
                                });
        ...
        let popover_menu = PopoverMenu::new("settings-popover")
            ...
            .menu(move |window, cx| {
                Some(ContextMenu::build(window, cx, |context_menu, _, _| {
                    context_menu
                        .action("Open Settings", zed_custom_actions::OpenSettings.boxed_clone())
                        .action(
                            "Edit settings.json",
                    ...
                    .child(SplitButton::new(
                        ButtonLike::new("open-settings-ui")
                            ...
                            .on_click(|_, window, cx| {
                                window.dispatch_action(zed_custom_actions::OpenSettings.boxed_clone(), cx);
                            }),
