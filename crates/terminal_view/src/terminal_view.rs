...
use zed_custom_actions::{agent::AddSelectionToThread, assistant::InlineAssist};
...
fn terminal_rerun_override(task: &TaskId) -> zed_custom_actions::Rerun {
    zed_custom_actions::Rerun {
