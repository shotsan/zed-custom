...
use zed_custom_actions::{ToggleFocus as ToggleDebugPanel, dev};

pub fn app_menus(cx: &mut App) -> Vec<Menu> {
    use zed_custom_actions::Quit;

    let mut view_items = vec![
        MenuItem::action(
            "Zoom In",
            zed_custom_actions::IncreaseBufferFontSize { persist: false },
        ),
        MenuItem::action(
            "Zoom Out",
            zed_custom_actions::DecreaseBufferFontSize { persist: false },
        ),
        MenuItem::action(
            "Reset Zoom",
            zed_custom_actions::ResetBufferFontSize { persist: false },
        ),
        MenuItem::action(
            "Reset All Zoom",
            zed_custom_actions::ResetAllZoom { persist: false },
        ),
        MenuItem::separator(),
        ...
        MenuItem::separator(),
        MenuItem::action("Project Panel", zed_custom_actions::project_panel::ToggleFocus),
    ...
    vec![
        Menu {
            ...
            items: vec![
                MenuItem::action("About zed-custom", zed_custom_actions::About),
                MenuItem::action("Check for Updates", auto_update::Check),
                MenuItem::separator(),
                MenuItem::submenu(Menu {
                    name: "Settings".into(),
                    items: vec![
                        MenuItem::action("Open Settings", zed_custom_actions::OpenSettings),
                        MenuItem::action("Open Settings File", super::OpenSettingsFile),
                        MenuItem::action("Open Project Settings", zed_custom_actions::OpenProjectSettings),
                        MenuItem::action(
                        ...
                        MenuItem::separator(),
                        MenuItem::action("Open Keymap", zed_custom_actions::OpenKeymap),
                        MenuItem::action("Open Keymap File", zed_custom_actions::OpenKeymapFile),
                        MenuItem::action(
                        ...
                        MenuItem::action(
                            "Select Theme...",
                            zed_custom_actions::theme_selector::Toggle::default(),
                        ),
                        MenuItem::action(
                            "Select Icon Theme...",
                            zed_custom_actions::icon_theme_selector::Toggle::default(),
                        ),
                    ],
                }),
                MenuItem::separator(),
                ...
                MenuItem::separator(),
                MenuItem::action("Extensions", zed_custom_actions::Extensions::default()),
                #[cfg(not(target_os = "windows"))]
                MenuItem::action("Install CLI", install_cli::InstallCliBinary),
                MenuItem::separator(),
                #[cfg(target_os = "macos")]
                MenuItem::action("Hide zed-custom", super::Hide),
                #[cfg(target_os = "macos")]
                MenuItem::action("Hide Others", super::HideOthers),
                #[cfg(target_os = "macos")]
                MenuItem::action("Show All", super::ShowAll),
                MenuItem::separator(),
                MenuItem::action("Quit zed-custom", Quit),
            ],
        },
        Menu {
            name: "File".into(),
            items: vec![
                ...
                MenuItem::action(
                    "Open Recent...",
                    zed_custom_actions::OpenRecent {
                        create_new_window: false,
                    },
                ),
                MenuItem::action(
                    "Open Remote...",
                    zed_custom_actions::OpenRemote {
                        create_new_window: false,
        ...
        Menu {
            ...
            items: vec![
                ...
                MenuItem::separator(),
                MenuItem::action("Command Palette...", zed_custom_actions::command_palette::Toggle),
                MenuItem::separator(),
                MenuItem::action("Go to File...", workspace::ToggleFileFinder::default()),
                // MenuItem::action("Go to Symbol in Project", project_symbols::Toggle),
                MenuItem::action(
                    "Go to Symbol in Editor...",
                    zed_custom_actions::outline::ToggleOutline,
                ),
        ...
        Menu {
            ...
            items: vec![
                MenuItem::action(
                    "Spawn Task",
                    zed_custom_actions::Spawn::ViaModal {
                        reveal_target: None,
                    },
                ),
                MenuItem::action("Start Debugger", debugger_ui::Start),
                MenuItem::separator(),
                MenuItem::action("Edit tasks.json...", crate::zed_custom::OpenProjectTasks),
                MenuItem::action("Edit debug.json...", zed_custom_actions::OpenProjectDebugTasks),
                MenuItem::separator(),
        ...
        Menu {
            ...
            items: vec![
                ...
                MenuItem::action("View Telemetry", zed_custom_actions::OpenTelemetryLog),
                MenuItem::action("View Dependency Licenses", zed_custom_actions::OpenLicenses),
                MenuItem::action("Show Welcome", onboarding::ShowWelcome),
                MenuItem::separator(),
                MenuItem::action("File Bug Report...", zed_custom_actions::feedback::FileBugReport),
                MenuItem::action("Request Feature...", zed_custom_actions::feedback::RequestFeature),
                MenuItem::action("Email Us...", zed_custom_actions::feedback::EmailZedCustom),
                MenuItem::separator(),
                MenuItem::action(
                    "Documentation",
                    super::OpenBrowser {
                ...
                MenuItem::action("zed-custom Repository", feedback::OpenZedCustomRepo),
                MenuItem::action(
                    "zed-custom Twitter",
                    super::OpenBrowser {
