...
fn instance_handshake() -> &'static str {
    match *release_channel::RELEASE_CHANNEL {
        ReleaseChannel::Dev => "zed-custom Editor Dev Instance Running",
        ReleaseChannel::Nightly => "zed-custom Editor Nightly Instance Running",
        ReleaseChannel::Preview => "zed-custom Editor Preview Instance Running",
        ReleaseChannel::Stable => "zed-custom Editor Stable Instance Running",
    }
}
