            ...
            single_example(
                ...
                container()
                    .child(
                        ...
                        .child(Label::new("zed_custom").color(Color::Muted)),
                    )
                    .into_any_element(),
            ),
            single_example(
                ...
                container()
                    .child(
                        ...
                        .child(Label::new(
                            "a_very_long_username_that_might_overflow is sharing a project in zed-custom:",
                        ))
                        .child(
                            Label::new("zed_custom-cloud, zed_custom, edit-prediction-bench, zed.dev")
                                .color(Color::Muted),
                        ),
                    )
                    .into_any_element(),
