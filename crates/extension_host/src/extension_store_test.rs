...
async fn test_extension_store(cx: &mut TestAppContext) {
    ...
    fs.insert_tree(
        ...
        json!({
            "installed": {
                "zed_custom-monokai": {
                    "extension.json": r#"{
                        "id": "zed_custom-monokai",
                        "name": "zed-custom Monokai",
                        "version": "2.0.0",
                        "themes": {
    ...
    let mut expected_index = ExtensionIndex {
        extensions: [
            (
                "zed_custom-ruby".into(),
                ExtensionIndexEntry {
                    manifest: Arc::new(ExtensionManifest {
                        id: "zed_custom-ruby".into(),
                        name: "zed-custom Ruby".into(),
                        version: "1.0.0".into(),
            ...
            (
                "zed_custom-monokai".into(),
                ExtensionIndexEntry {
                    manifest: Arc::new(ExtensionManifest {
                        id: "zed_custom-monokai".into(),
                        name: "zed-custom Monokai".into(),
                        version: "2.0.0".into(),
                        schema_version: SchemaVersion::ZERO,
                        description: None,
                        authors: vec![],
        ...
        languages: [
            (
                ...
                ExtensionIndexLanguageEntry {
                    extension: "zed_custom-ruby".into(),
        ...
        themes: [
            (
                ...
                ExtensionIndexThemeEntry {
                    extension: "zed_custom-monokai".into(),
    ...
    fs.insert_tree(
        "/the-extension-dir/installed/zed_custom-gruvbox",
        json!({
            "extension.json": r#"{
                "id": "zed_custom-gruvbox",
                "name": "zed-custom Gruvbox",
                "version": "1.0.0",
                "themes": {
    ...
    expected_index.extensions.insert(
        "zed_custom-gruvbox".into(),
        ExtensionIndexEntry {
            manifest: Arc::new(ExtensionManifest {
                id: "zed_custom-gruvbox".into(),
                name: "zed-custom Gruvbox".into(),
                version: "1.0.0".into(),
                schema_version: SchemaVersion::ZERO,
                description: None,
                authors: vec![],
    ...
    expected_index.themes.insert(
        "Gruvbox".into(),
        ExtensionIndexThemeEntry {
            extension: "zed_custom-gruvbox".into(),
    ...
    store.update(cx, |store, cx| {
        store
            .uninstall_extension("zed_custom-ruby".into(), cx)
            .detach_and_log_err(cx);
    });

    cx.executor().advance_clock(RELOAD_DEBOUNCE_DURATION);
    expected_index.extensions.remove("zed_custom-ruby");
