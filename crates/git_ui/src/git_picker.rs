...
pub fn open_branches(
    ...
    _: &zed_custom_actions::git::Branch,
    window: &mut Window,
...
pub fn open_worktrees(
    workspace: &mut Workspace,
    _: &zed_custom_actions::git::Worktree,
    window: &mut Window,
    cx: &mut Context<Workspace>,
) {
...
pub fn open_stash(
    workspace: &mut Workspace,
    _: &zed_custom_actions::git::ViewStash,
    window: &mut Window,
    cx: &mut Context<Workspace>,
) {
...
pub fn register(workspace: &mut Workspace) {
    workspace.register_action(|workspace, _: &zed_custom_actions::git::Branch, window, cx| {
        open_with_tab(workspace, GitPickerTab::Branches, window, cx);
    });
    workspace.register_action(|workspace, _: &zed_custom_actions::git::Switch, window, cx| {
        open_with_tab(workspace, GitPickerTab::Branches, window, cx);
    });
    workspace.register_action(
        |workspace, _: &zed_custom_actions::git::CheckoutBranch, window, cx| {
            open_with_tab(workspace, GitPickerTab::Branches, window, cx);
        },
    );
    workspace.register_action(|workspace, _: &zed_custom_actions::git::Worktree, window, cx| {
        open_with_tab(workspace, GitPickerTab::Worktrees, window, cx);
    });
    workspace.register_action(|workspace, _: &zed_custom_actions::git::ViewStash, window, cx| {
        open_with_tab(workspace, GitPickerTab::Stash, window, cx);
    });
}
