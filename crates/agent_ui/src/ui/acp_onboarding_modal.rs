...
impl Render for AcpOnboardingModal {
    fn render(&mut self, _: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        let heading = v_flex()
            ...
            .child(Headline::new("Bring Your Own Agent to zed-custom").size(HeadlineSize::Large));

        let copy = "Bring the agent of your choice to zed-custom via our new Agent Client Protocol (ACP), starting with Google's Gemini CLI integration.";
