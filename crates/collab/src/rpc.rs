...
impl Header for ProtocolVersion {
    fn name() -> &'static HeaderName {
        ...
        ZED_PROTOCOL_VERSION.get_or_init(|| HeaderName::from_static("x-zed_custom-protocol-version"))
    }
...
impl Header for AppVersionHeader {
    fn name() -> &'static HeaderName {
        ...
        ZED_APP_VERSION.get_or_init(|| HeaderName::from_static("x-zed_custom-app-version"))
    }
...
impl Header for ReleaseChannelHeader {
    fn name() -> &'static HeaderName {
        ...
        ZED_RELEASE_CHANNEL.get_or_init(|| HeaderName::from_static("x-zed_custom-release-channel"))
    }
...
async fn join_channel_internal(
    ...
    let joined_room = {
        ...
        // If zed_custom quits without leaving the room, and the user re-opens zed_custom before the
...
async fn send_channel_message(
    ...
    Err(anyhow!("chat has been removed in the latest version of zed-custom").into())
}
