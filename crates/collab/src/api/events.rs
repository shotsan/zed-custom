...
impl Header for ZedChecksumHeader {
    fn name() -> &'static HeaderName {
        ...
        ZED_CHECKSUM_HEADER.get_or_init(|| HeaderName::from_static("x-zed_custom-checksum"))
    }
...
fn for_snowflake(
    ...
    body.events.into_iter().map(move |event| {
        ...
        // dictionary. See https://app.amplitude.com/data/zed_custom/Zed/sources/detail/production/falcon%3A159998
