...
impl Render for KeyContextView {
    fn render(&mut self, _: &mut Window, cx: &mut Context<Self>) -> impl ui::IntoElement {
        ...
        v_flex()
            ...
            .child(Label::new("This view lets you determine the current context stack for creating custom key bindings in zed-custom. When a keyboard shortcut is triggered, it also shows all the possible contexts it could have triggered in, and which one matched."))
            .child(
                h_flex()
                    .mt_4()
                    .gap_4()
                    ...
                    .child(
                        Button::new("view_default_keymap", "View Default Keymap")
                            ...
                            .on_click(|_, window, cx| {
                                window.dispatch_action(zed_custom_actions::OpenDefaultKeymap.boxed_clone(), cx);
                            }),
                    )
                    .child(
                        Button::new("edit_your_keymap", "Edit Keymap File")
                            .style(ButtonStyle::Filled)
                            .key_binding(ui::KeyBinding::for_action(&zed_custom_actions::OpenKeymapFile, cx))
                            .on_click(|_, window, cx| {
