    ...
    cx.observe_new(|workspace: &mut Workspace, _, _| {
        ...
        workspace.register_action(|_, _: &ToggleProjectPanelFocus, window, cx| {
            if Vim::take_count(cx).is_none() {
                window.dispatch_action(zed_custom_actions::project_panel::ToggleFocus.boxed_clone(), cx);
            }
        });
        ...
        workspace.register_action(|_, _: &zed_custom_actions::vim::OpenDefaultKeymap, _, cx| {
