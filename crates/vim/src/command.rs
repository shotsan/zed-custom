...
use zed_custom_actions::{OpenDocs, RevealTarget};
...
fn generate_commands(_: &App) -> Vec<VimCommand> {
    vec![
        ...
        VimCommand::new(("cq", "uit"), zed_custom_actions::Quit),
        VimCommand::new(
            ("bd", "elete"),
            workspace::CloseActiveItem {
                save_intent: Some(SaveIntent::Close),
        ...
        VimCommand::str(("opt", "ions"), "zed_custom::OpenDefaultSettings"),
...
impl OnMatchingLines {
    // convert a vim query into something more usable by zed_custom.
