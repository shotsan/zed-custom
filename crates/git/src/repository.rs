...
mod tests {
    ...
    fn test_branches_parsing() {
        ...
        let input = "*\0060964da10574cd9bf06463a53bf6e0769c5c45e\0\0refs/heads/zed_custom-patches\0refs/remotes/origin/zed_custom-patches\0\01733187470\0John Doe\0generated protobuf\n";
        assert_eq!(
            parse_branch_input(input).unwrap(),
            vec![Branch {
                is_head: true,
                ref_name: "refs/heads/zed_custom-patches".into(),
                upstream: Some(Upstream {
                    ref_name: "refs/remotes/origin/zed_custom-patches".into(),
