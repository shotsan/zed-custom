    ...
    fn security_section() -> [SettingsPageItem; 2] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "When opening zed-custom, avoid Restricted Mode by auto-trusting all projects, enabling use of all features without having to give permission to each new project.",
                field: Box::new(SettingField {
    ...
    fn workspace_restoration_section() -> [SettingsPageItem; 3] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "What to restore from the previous session when opening zed-custom.",
                field: Box::new(SettingField {
    ...
    fn scoped_settings_section() -> [SettingsPageItem; 3] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "Which settings should be activated only in Preview build of zed-custom.",
                field: Box::new(
                    SettingField {
    ...
    fn privacy_section() -> [SettingsPageItem; 3] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "Send anonymized usage data like what languages you're using zed-custom with.",
                field: Box::new(SettingField {
        ...
        [
            ...
            SettingsPageItem::DynamicItem(DynamicItem {
                discriminant: SettingItem {
                    files: USER,
                    title: "Icon Theme",
                    description: "The custom set of icons zed-custom will associate with files and directories.",
                    field: Box::new(SettingField {
                ...
                on_click: Arc::new(|settings_window, window, cx| {
                    ...
                    original_window
                        .update(cx, |_workspace, original_window, cx| {
                            original_window
                                .dispatch_action(zed_custom_actions::OpenKeymap.boxed_clone(), cx);
    ...
    fn file_scan_section() -> [SettingsPageItem; 5] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "Files or globs of files that will be excluded by zed-custom entirely. They will be skipped during file scans, file searches, and not be displayed in the project file tree. Takes precedence over \"File Scan Inclusions\"",
                field: Box::new(
                    SettingField {
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "Files or globs of files that will be included by Zed, even when ignored by git. This is useful for files that are not tracked by git, but are still important to your project. Note that globs that are overly broad can slow down zed-custom's file scanning. \"File Scan Exclusions\" takes precedence over these inclusions",
                field: Box::new(
                    SettingField {
    ...
    fn window_section() -> [SettingsPageItem; 3] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "(Linux only) whether zed-custom or your compositor should draw window decorations.",
                field: Box::new(SettingField {
    ...
    fn general_section() -> [SettingsPageItem; 6] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "Whether breakpoints should be reused across zed-custom sessions.",
                field: Box::new(SettingField {
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "Whether to log messages between active debug adapters and zed-custom.",
                field: Box::new(SettingField {
        ...
        [
            ...
            SettingsPageItem::DynamicItem(DynamicItem {
                discriminant: SettingItem {
                    ...
                    description: "Disable all Git integration features in zed-custom.",
...
fn network_page() -> SettingsPage {
    fn network_section() -> [SettingsPageItem; 3] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                title: "Server URL",
                description: "The URL of the zed-custom server to connect to.",
                field: Box::new(SettingField {
...
fn language_settings_data() -> Box<[SettingsPageItem]> {
    ...
    fn autoclose_section() -> [SettingsPageItem; 5] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                title: "Use Autoclose",
                description: "Whether to automatically type closing characters for you. For example, when you type '(', zed-custom will automatically add a closing ')' at the correct position.",
                field: Box::new(SettingField {
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "Whether to automatically surround text with characters for you. For example, when you select text and type '(', zed-custom will automatically surround text with ().",
                field: Box::new(SettingField {
    ...
    fn tasks_section() -> [SettingsPageItem; 4] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                title: "Prefer LSP",
                description: "Use LSP tasks over zed-custom language extension tasks.",
                field: Box::new(SettingField {
...
fn edit_prediction_language_settings_section() -> [SettingsPageItem; 4] {
    [
        ...
        SettingsPageItem::SubPageLink(SubPageLink {
            ...
            description: Some("Set up different edit prediction providers in complement to zed-custom's built-in Zeta model.".into()),
            in_json: false,
            files: USER,
