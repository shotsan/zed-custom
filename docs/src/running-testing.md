...
This section covers how to run, test, and debug your code without leaving zed-custom.

## What's here

- **[Terminal](./terminal.md)**: zed-custom's built-in terminal emulator. Open multiple terminals, customize your shell, and integrate with the editor. Tasks and commands run here.
...
- **[Debugger](./debugger.md)**: Set breakpoints, step through code, and inspect variables using zed-custom's built-in debugger. Works with C, C++, Go, JavaScript, Python, Rust, TypeScript, and more through the Debug Adapter Protocol.
