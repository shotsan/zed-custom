...
zed-custom allows you to have private calls / collaboration sessions with those in your contacts.
...
1. Search for the contact using their GitHub handle.\
   _Note: Your contact must be an existing zed-custom user who has completed the GitHub authentication sign-in flow._
