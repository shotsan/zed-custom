# Building zed-custom for FreeBSD

Note, FreeBSD is not currently a supported platform, and so this is a work-in-progress.

## Repository

Clone the [zed-custom repository](https://github.com/zed-industries/zed-custom).
...
- Install the necessary system packages and rustup:
  ...
  If preferred, you can inspect [`script/freebsd`](https://github.com/zed-industries/zed-custom/blob/main/script/freebsd) and perform the steps manually.
...
See [Issue #15309: FreeBSD Support] and [Discussion #29550: Unofficial FreeBSD port for zed-custom] for more.
