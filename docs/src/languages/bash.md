...
Bash language support in zed-custom is provided by the community-maintained [Basher extension](https://github.com/d1y/bash.zed-custom).
Report issues to: [https://github.com/d1y/bash.zed-custom/issues](https://github.com/d1y/bash.zed-custom/issues)
...
- [zed-custom Docs: Language Support: Shell Scripts](./sh.md)
