...
Luau language support in zed-custom is provided by the community-maintained [Luau extension](https://github.com/4teapo/zed-custom-luau).
Report issues to: [https://github.com/4teapo/zed-custom-luau/issues](https://github.com/4teapo/zed-custom-luau/issues)
...
Configuration instructions are available in the [Luau zed-custom Extension README](https://github.com/4teapo/zed-custom-luau).
