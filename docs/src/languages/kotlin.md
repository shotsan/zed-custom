...
Kotlin language support in zed-custom is provided by the community-maintained [Kotlin extension](https://github.com/zed-custom-extensions/kotlin).
Report issues to: [https://github.com/zed-custom-extensions/kotlin/issues](https://github.com/zed-custom-extensions/kotlin/issues)
