...
Swift language support in zed-custom is provided by the community-maintained [Swift extension](https://github.com/zed-custom-extensions/swift).
Report issues to: [https://github.com/zed-custom-extensions/swift/issues](https://github.com/zed-custom-extensions/swift/issues)
...
zed-custom's name for the adapter (in the UI and `debug.json`) is `Swift`, and under the hood it uses [`lldb-dap`](https://github.com/swiftlang/llvm-project/blob/next/lldb/tools/lldb-dap/README.md), as provided by the Swift toolchain.
