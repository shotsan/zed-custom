...
Scala language support in zed-custom is provided by the community-maintained [Scala extension](https://github.com/scalameta/metals-zed-custom).
Report issues to: [https://github.com/scalameta/metals-zed-custom/issues](https://github.com/scalameta/metals-zed-custom/issues)
...
<!--
TBD: Provide LSP configuration example for metals in zed-custom settings.json. metals.{javaHome,excludedPackages,customProjectRoot} etc.
-->
