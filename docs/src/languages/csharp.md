...
C# support is available through the [C# extension](https://github.com/zed-custom-extensions/csharp).
...
The `OmniSharp` binary can be configured in a zed-custom settings file with:
