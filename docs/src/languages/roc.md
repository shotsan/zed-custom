...
Roc language support in zed-custom is provided by the community-maintained [Roc extension](https://github.com/h2000/zed-custom-roc).
Report issues to: [https://github.com/h2000/zed-custom-roc/issues](https://github.com/h2000/zed-custom-roc/issues)
