...
PowerShell language support in zed-custom is provided by the community-maintained [zed-custom PowerShell extension](https://github.com/wingyplus/zed-custom-powershell). Please report issues to: [github.com/wingyplus/zed-custom-powershell/issues](https://github.com/wingyplus/zed-custom-powershell/issues)
...
The zed-custom PowerShell extension will default to the `pwsh` executable found in your path.

### Install PowerShell Editor Services (Optional) {#powershell-editor-services}

The zed-custom PowerShell extensions will attempt to download [PowerShell Editor Services](https://github.com/PowerShell/PowerShellEditorServices) automatically.

If want to use a specific binary, you can specify in your that in your zed-custom settings.json:
