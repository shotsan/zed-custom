...
Emmet support is available through the [Emmet extension](https://github.com/zed-custom-extensions/emmet).
...
<!--
TBD: Document Emmet usage in zed-custom with: HTML, PHP, ERB, Javascript, TSX, CSS
-->
