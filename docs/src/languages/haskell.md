...
Haskell support is available through the [Haskell extension](https://github.com/zed-custom-extensions/haskell).
...
If you need to configure haskell-language-server (hls) you can add configuration options to your zed-custom settings.json:
