...
Svelte support is available through the [Svelte extension](https://github.com/zed-custom-extensions/svelte).
...
When inlay hints is enabled in zed-custom, to make the language server send them back, zed-custom sets the following initialization options:
