...
Check out all the MCP servers that have already been exposed as extensions [on zed-custom's site](https://zed.dev/extensions?filter=context-servers).
