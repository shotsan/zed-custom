...
Learn how to get started using AI with zed-custom and all its capabilities.

## Setting up AI in zed-custom
...
- [External Agents](./external-agents.md): Learn how to plug in your favorite agent into zed-custom.

- [Subscription](./subscription.md): Learn about zed-custom's hosted models and other billing-related information.

- [Privacy and Security](./privacy-and-security.md): Understand how zed-custom handles privacy and security with AI features.
...
- [Edit Prediction](./edit-prediction.md): Learn about zed-custom's AI prediction feature that helps autocomplete your code.
