...
When using AI in zed-custom, you can configure multiple dimensions:

1. Which LLM providers you can use
   - zed-custom's hosted models, which require [authentication](../authentication.md) and [subscription](./subscription.md)
...
We want to respect users who want to use zed-custom without interacting with AI whatsoever.
