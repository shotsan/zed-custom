...
### 1. The `@remember` Tool
When you make a significant design decision or figure out a tricky bug, you can tell the agent to remember it. The agent will categorize the memory (e.g., *Architecture*, *Patterns*, *Issues*, *Procedures*, or *Notes*) and record it in a local database scoped entirely to your current project. 
