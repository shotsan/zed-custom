...
features:
  ...
  - title: 🔍 Custom Search Endpoint
    details: Mount any HTTPS search endpoint (Elasticsearch, Algolia) as a native LLM tool call. The model can autonomously query your internal knowledge base and logs to solve issues, or you can search manually using <code>/custom-search</code>.
